        ...
        <div className='mt-16 '>
            ...
            <div className='flex flex-col sm:flex-row justify-between'>
                ...
                <div className='w-2/3 space-y-6'>
                    ...
                    <p className='text-sm font-light'>                        At Prescripto, we simplify healthcare by connecting patients with expert doctors. Our platform ensures timely consultations, secure medical records, and personalized care.
                    </p>
                </div>
